...
-- This script uses variables to insert ingredients into their respective categories
-- First, declare variables to store category IDs for easier management
...
-- Retrieve CategoryIDs for each category
